...
import 'package:flutter_demo_app/utils/detector_painters.dart';
import 'package:flutter_demo_app/utils/scanner_utils.dart';

class CameraPreviewScanner extends StatefulWidget {
  const CameraPreviewScanner({Key key, this.title, this.analytics, this.observer}) : super(key: key);
  ...
  Widget _buildResults() {
    ...
    switch (_currentDetector) {
      case Detector.barcode:
        ...
        painter =
            BarcodeDetectorPainter(imageSize, _scanResults as List<Barcode>);
        break;
      case Detector.face:
      ...
      case Detector.label:
        ...
        painter =
            LabelDetectorPainter(imageSize, _scanResults as List<ImageLabel>);
        break;
      default:
